...
if (!class_exists('Redux_Framework_sample_config')) {
    ...
    class Redux_Framework_sample_config {
        ...
        function dynamic_section($sections) {
            //$sections = array();
            $sections[] = array(
                'title' => __('Section via hook', 'hedmark'),
                'desc' => __('<p class="description">This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.</p>', 'hedmark'),
        ...
        public function setHelpTabs() {
            ...
            $this->args['help_tabs'][] = array(
                'id'        => 'redux-help-tab-1',
                'title'     => esc_html__('Theme Information 1', 'hedmark'),
                'content'   => esc_html__('<p>This is the tab content, HTML is allowed.</p>', 'hedmark')
            );

            $this->args['help_tabs'][] = array(
                'id'        => 'redux-help-tab-2',
                'title'     => esc_html__('Theme Information 2', 'hedmark'),
                'content'   => esc_html__('<p>This is the tab content, HTML is allowed.</p>', 'hedmark')
            );

            // Set the help sidebar
            $this->args['help_sidebar'] = esc_html__('<p>This is the sidebar content, HTML is allowed.</p>', 'hedmark');
        }
        ...
        public function setArguments() {
			...
			$fonts_api_key = $hedmark_option['google_fonts_api'];

            $this->args = array(
                // TYPICAL -> Change these values as you need/desire
                'opt_name'          => 'hedmark_option',            // This is where your data is stored in the database and also becomes your global variable name.
                'display_name'      => $theme->get('Name'),     // Name that appears at the top of your panel
                'display_version'   => $theme->get('Version'),  // Version that appears at the top of your panel
                'menu_type'         => 'submenu',                  //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
                'allow_sub_menu'    => true,                    // Show the sections below the admin menu item or not
                'menu_title'        => __('Theme Options', 'hedmark'),
                'page_title'        => __('Theme Options', 'hedmark'),
                
                // You will need to generate a Google API key to use this feature.
                // Please visit: https://developers.google.com/fonts/docs/developer_api#Auth
                
				'google_api_key' =>$fonts_api_key, // Must be defined to add google fonts to the typography module
            ...
            $this->args['share_icons'][] = array(
                'url'   => 'https://www.facebook.com/khalilthemes',
                'title' => 'Like us on Facebook',
                'icon'  => 'el-icon-facebook'
            );
            $this->args['share_icons'][] = array(
                'url'   => 'http://twitter.com/khalilthemes',
